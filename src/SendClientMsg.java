...
public class SendClientMsg extends Thread
{
     ...
     */
    public synchronized void addClient(NodeInfo aClientInfo)
    {
     ...
     */
    public synchronized void deleteClient(NodeInfo aClientInfo)
    {
     ...
     */
    public synchronized void dispatchMessage(NodeInfo aClientInfo, String aMessage)
    {
    ...
    throws InterruptedException
    {
        while (mMessages.size()==0)
           wait();
        String message = (String) mMessages.get(0);
    ...
    private synchronized void sendMessageToAllClients(String aMessage)
    {
        for (int i=0; i<mClients.size(); i++) {
           NodeInfo clientInfo = (NodeInfo) mClients.get(i);
