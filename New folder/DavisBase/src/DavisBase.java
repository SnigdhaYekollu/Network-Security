...
public class DavisBase {
	...
	static String prompt = "snisql> ";
	static String version = "v1.0";
	static String copyright = "Â©2017 Snigdha Yekollu";
	static boolean isExit = false;
	/*
	 * Page size for all files is 512 bytes by default. You may choose to make
	 * it user modifiable
	 */
	...
	public static void splashScreen() {
		...
		System.out.println("Welcome to DavisBase -> SniLite"); // Display the
																// string.
		System.out.println("SniLite Version " + getVersion());
	...
	public static void help() {
		...
		System.out.println("\tSHOW TABLES;			                 Displays a list of all tables.   ");
		System.out.println("\tDELETE FROM TABLE table_name  			 Deletes a single record.         ");
		System.out.println("\tWHERE row_id = key_value;														");
		System.out.println("\tCREATE TABLE table_name(arguments);              Creates a new empty table.");
		System.out.println("\tINSERT INTO TABLE (column_list) table_name       Insert a new record.");
		System.out.println("\tVALUES (value1,value2,value3,…);												");
		System.out.println("\tUPDATE table_name SET column_name                Modifies one or more records.");
		System.out.println("\t= value [WHERE condition];");
	...
	/** return the DavisBase SniBase version */
